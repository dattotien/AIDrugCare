...
export default function DoctorInforScene({
  doctor,
  onSave,
  onClose,
}: DoctorInforProps) {
    ...
    <div className="profile-container">
      <div className="profile-header">
        <div className="avatar">
          <UserOutlined
            style={{ fontSize: "60px", color: "#ffffff", top: "100px" }}
          />
        </div>
        <div>
          <h2
            className="header-name"
            style={{ position: "absolute", top: "80px", left: "185px" }}
          >
            BS: {doctor.name}
          </h2>
          <p
      ...
      <div className="profile-footer">{doctor.workplace}</div>
    </div>
  );
}
